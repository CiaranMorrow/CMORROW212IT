...
public class SignUp extends javax.swing.JFrame 
{
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jUsernameField1, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String inputUsername = jUsernameField1.getText();
        
        try
        {
            //converts password input to sha1
            shaPassword = sha1(jPasswordField1.getPassword()); 
        }
        ...
        if (isValid == true)
        {
            //fill model and update db
            Users user = new Users();
            user.setUsername(jUsernameField1.getText());
            user.setPassword(shaPassword);
            connectionManagementService.AddUser(user, conn);
        ...
        {
            JOptionPane.showMessageDialog(null, "User already exists", "Invalid Username", JOptionPane.WARNING_MESSAGE);
        }
